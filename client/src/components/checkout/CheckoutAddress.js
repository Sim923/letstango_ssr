...
class CheckoutAddress extends Component {
  ...
  console.log(newprops)
      if(newprops)
        if((typeof newprops.address !== 'undefined')){
          var isValidAddress = newprops.address.default_address_id?true:false
          this.setState({selectedAddress:newprops.address.default_address_id,
                          addNewAddress:isValidAddress})
        }
  ...
  componentDidMount(){
    ...
    if((typeof this.props.address !== 'undefined')){
          var isValidAddress = this.props.address.default_address_id?true:false
          this.setState({selectedAddress:this.props.address.default_address_id,
                          addNewAddress:isValidAddress})
        }
      ...
      for(var i=0;i<data.addresses.length;i++){
        ...
        if(defaultAddressId == data.addresses[i].address_id){
          addressDetail= {"customer_name" : data.addresses[i].name,
                          ...
                          "country_name"  : data.addresses[i].country_name,
  ...
  getArea =  (statecode) => {
    ...
    const data = this.props.address
    const { fullName, selectedCountry,selcetedCity,selcetedRegion,
    ...
    return(
			...
			<div className="col-12 col-md-8 cart-left-body">
              ...
              <div className="step_1">
				...
				<div className="row justify-content-center mobile-log-button">
                	<div className="col-12 col-md-8 tittle-block text-center">
                    	 <p className="text-center">If you are already a registered user please click below to login</p>
						 <button id="addaddress#" role="button" className="buynowbutton">
                        Log IN
                     	</button>
                    </div>
                 </div>
                    ...
                    <div key={key} className="row justify-content-center">
                      <div className="col-11 col-md-10 address-block">
                          <p><strong>{item.name}</strong></p>
                            <p>{(item.area).join()}</p>
                            <p>{item.region}, {item.city}, {item.country_name}</p>
              ...
              <div id="addaddress" className="row justify-content-center">
                ...
                <div className="col-12 col-md-5">
                      <div className="form-group float-label-control" id="country">
                        ...
                        <select className="form-control" data-live-search="true" id="country-list" data-live-search="true" defaultValue = {selectedCountry} 
                              onChange={this.onCountryChange}>
                            <option value = {selectedCountryCode}>{selectedCountry}</option>
                    ...
                    <div className="form-group float-label-control" id="state">
                ...
                <div className="col-12 col-md-10">
                  <div className="row">
                    ...
                    <div className="form-group float-label-control" id="city">
                        
                        <select className="form-control" id="city-lists" onChange={this.onRegionChange}>
